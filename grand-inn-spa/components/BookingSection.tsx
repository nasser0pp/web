...
import { SPA_PHONE_FORMATTED, SPA_WHATSAPP_NUMBER, SPA_EMAIL } from '../constants';
...
const BookingSection: React.FC<BookingSectionProps> = ({ id }) => {
  const whatsappLink = `https://wa.me/${SPA_WHATSAPP_NUMBER}?text=${encodeURIComponent("Hello Grand Inn Spa, I'd like to make a booking or inquiry.")}`;

  return (
    <SectionContainer id={id} title="Book Your Moment of Bliss" className="bg-brand-lavender-light">
