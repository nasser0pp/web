...
import { SPA_TAGLINE } from '../constants';
...
const HeroSection: React.FC<HeroSectionProps> = ({ id, onBookNow }) => {
  return (
    <section id={id} className="relative h-screen flex items-center justify-center text-center bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://picsum.photos/seed/spa-hero/1920/1080')"}}>
      <div className="absolute inset-0 bg-black opacity-40"></div>
      <div className="relative z-10 p-4 animate-fadeIn">
        <h1 className="text-4xl sm:text-5xl md:text-6xl font-serif text-brand-white font-bold mb-6 drop-shadow-lg">
          {SPA_TAGLINE}
        </h1>
