    ...
    <SectionContainer id={id} title={`Welcome to ${SPA_NAME}`} className="bg-brand-beige">
      <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12">
        <div className="md:w-1/2 animate-slideInUp" style={{animationDelay: '0.2s'}}>
          <img 
            src="https://picsum.photos/seed/hilton-spa-interior/600/400" 
        ...
        <div className="md:w-1/2 space-y-6 text-brand-charcoal-light animate-slideInUp" style={{animationDelay: '0.4s'}}>
          <p className="text-lg leading-relaxed">
            Nestled within the Hilton Garden Inn Muscat Al Khuwair, ${SPA_NAME} is more than just a spa – it's an escape, a sanctuary dedicated to your complete well-being. Our mission is to provide an unparalleled experience of relaxation and rejuvenation, allowing you to disconnect from the stresses of daily life and reconnect with your inner peace.
          </p>
