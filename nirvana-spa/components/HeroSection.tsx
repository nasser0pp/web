...
const HeroSection: React.FC<HeroSectionProps> = ({ id, onBookNow }) => {
  return (
    <section id={id} className="relative h-screen flex items-center justify-center text-center bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://picsum.photos/seed/premium-spa-hero/1920/1080')"}}>
